...
insert into places (name, category, description_fr, address, position)
select * from (values
  ('Boulangerie de dépannage', 'Boulangerie', 'À l''angle de la rue de Charonne et de la rue Basfroi, la plus proche de l''appartement (1 min). Baguette tradition correcte.', 'Angle rue de Charonne / rue Basfroi', 1),
  ('Façon', 'Boulangerie', 'Vers le métro Charonne, à l''angle avec la rue Ledru-Rollin (3 min). Bon pain, bonnes viennoiseries et bonne pâtisserie — coup de cœur pour le flan.', 'Rue Ledru-Rollin, vers métro Charonne', 2),
  ('Magali', 'Boulangerie', 'Autre bonne boulangerie du quartier (5 min).', null, 3),
  ('Lendemain', 'Boulangerie', 'Autre bonne boulangerie du quartier (5 min).', null, 4),
  ('Brutus', 'Boulangerie', 'Autre bonne boulangerie du quartier (5 min) — coup de cœur pour la tartelette au chocolat.', null, 5),
  ('La Main Verte', 'Primeur', 'Bons fruits et légumes, au bout de la rue Basfroi (2 min).', 'Rue Basfroi', 6),
  ('Tapisserie', 'Pâtisserie', 'Excellentes pâtisseries, de la même maison que le restaurant étoilé Le Septime. Coup de cœur pour le chou à la flouve.', 'Rue de Charonne', 7),
  ('Paris Hanoï', 'Restaurant', 'Restaurant vietnamien, rue de Charonne.', 'Rue de Charonne', 8),
  ('Napoli Gang', 'Restaurant', 'Pizzas idéales à commander et à déguster à la maison.', 'Rue de Charonne', 9),
  ('Rue de la Roquette & Faubourg Saint-Antoine', 'Quartier', 'De nombreux restaurants — l''embarras du choix.', null, 10),
  ('Quartier Cyril Lignac', 'Quartier', 'Restaurant, boulangerie et chocolaterie du chef, à 5 minutes à pied.', null, 11),
  ('Square Raoul Nordling', 'Parc', 'Espace de jeux pour petits et grands, bancs pour les adultes (2 min).', 'Rue Saint-Bernard', 12),
  ('Jardin de la Folie-Titon', 'Parc', 'Bac à sable, toboggan et pelouse pour pique-niquer ou se détendre, quartier Lignac (5 min).', null, 13),
  ('Autres parcs du quartier', 'Parc', 'Plusieurs autres parcs à 5-10 minutes à pied.', null, 14),
  ('Monoprix Voltaire', 'Supermarché', 'Ouvert jusqu''à 21h, à 8 minutes à pied (métro Voltaire).', '166 avenue Ledru-Rollin, 75011 Paris', 15),
  ('Monoprix Faubourg Saint-Antoine', 'Supermarché', 'Ouvert jusqu''à 21h, à 8 minutes à pied (métro Ledru-Rollin).', '99 rue du Faubourg Saint-Antoine, 75011 Paris', 16)
) as v(name, category, description_fr, address, position)
