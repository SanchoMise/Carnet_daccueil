...
export const UI_LABELS = {
  ...
  connect_wifi: { fr: 'Se connecter en un clic', en: 'Connect in one tap', es: 'Conectarse con un toque' },
  wifi_qr_hint: { fr: 'Ou scannez le QR code affiché sur le frigo', en: 'Or scan the QR code on the fridge', es: 'O escanea el código QR pegado en el frigorífico' },
