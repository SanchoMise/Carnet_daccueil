    ...
    fields: [
      {
        ...
        translatable: true,
        type: 'textarea',
        group: "Porte de l'immeuble",
        label: { fr: "Description porte de l'immeuble", en: 'Building entrance description', es: 'Descripción de la entrada' },
      },
      {
        key: 'doors_note',
        translatable: true,
      ...
      },
      {
        ...
        type: 'textarea',
        group: 'Digicode',
        label: { fr: 'Note digicode', en: 'Keypad note', es: 'Nota del código' },
      },
      {
        key: 'digicode',
        translatable: false,
